...
//        processRequest(request, response);
        ...
        Quiz q = new QuizDBContext().getQuizById(quizId);
        request.setAttribute("quiz", q);

        Time t = q.getDuration();
        request.getRequestDispatcher("view/expert/EditQuiz.jsp").forward(request, response);
    }
...
//        processRequest(request, response);
        ...
        Quiz q = new Quiz(quizId,0,name,level,null,duration,null,null,null);
        new QuizDBContext().editQuiz(q);
