                    ...
                    <div class="">
                        ...
                        <div class="col-md-12">
                            <div class="card card-user" style="padding: 10px 10px; margin-left: 200px;margin-right: 200px; margin-top: 20px; margin-bottom: 50px;">
                                ...
                                <form  action="EditCourse" enctype="multipart/form-data" method="post" class="form-horizontal" style="padding: 20px">
                                    <fieldset style="color: rgb(35 100 60)">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <input id="course_name" name="courseName" value="${course.name}" class="form-control input-md" required="" type="text"/>
                                            ...
                                            <div class="col-md-6"  >
                                                ...
                                                <select  onmousedown="if(this.options.length>4){this.size=4;}"  onchange='this.size=0;' onblur="this.size=0;" size="5" style="width: 100%"  id="course_category" name="courseCategory" class="form-control">
                                                    ...
                                                    <c:forEach begin="1" end="${categoryList.size()-1}" var="i">
                                                        <option <c:if test="${course.category.name==categoryList[i].name}">selected</c:if> value="${categoryList[i].id}">${categoryList[i].name}</option>
                                                    </c:forEach>
                                                </select>
                                                </div>
                                            </div>
                                        ...
                                        <!-- Text input-->
                                        <div class="form-group">
                                            <label class="col-md-4 control-label" for="course_image_origin">COURSE IMAGE</label>  
                                            <div class="col-md-6">
                                                <img id="course_image_origin" src="${pageContext.request.contextPath}/assets/images/courses/${course.image}" alt="Author">
                                            </div>

                                        </div>
                                            <div class="form-group">
                                            <label class="col-md-4 control-label" for="course_image">EDIT IMAGE</label>  
                                            <div class="col-md-6">
                                                <input id="course_image" name="courseImage"  class="form-control input-md"  type="file"/>
                                                <input name="image" type = "text" style="display:none" value="${course.image}"> 
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">                     
                                                <textarea class="form-control" id="courseDescription" name="courseDescription"  required="">${course.description}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="padding-top: 5px" class="col-md-6">
                                                ...
                                                <input id="course_status" type="radio" value="1" name="courseStatus" <c:if test="${course.status}">checked</c:if>/> Published &nbsp;
                                                <input id="course_status" type="radio" value="0" name="courseStatus" <c:if test="${!course.status}">checked</c:if>/> Unpublished
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div style="padding-top: 5px" class="col-md-6">
                                                <!--<input id="course_status"  placeholder="COURSE STATUS" class="form-control input-md" required="" type="file" accept="image/*"/>-->
                                                <input id="course_featured" type="radio" value="1" name="courseFeatured" <c:if test="${course.featured}">checked</c:if>/> Yes &nbsp;
                                                <input id="course_featured" type="radio" value="0" name="courseFeatured" <c:if test="${!course.featured}">checked</c:if>/> No
