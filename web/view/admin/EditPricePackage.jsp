                ...
                <div class="col-md-12">
                    <div class="card card-user" style="padding: 10px 10px; margin-left: 200px;margin-right: 200px; margin-top: 50px; margin-bottom: 50px;">
                        <div class="card-header">
                            <h2 class="card-title">Edit a price package</h2>
                        </div>
                        <div class="card-body">

                            <form id="form" action="EditPricePackage" method="post">
                                <input type="hidden" name="courseId" value="${courseId}"/>
                                <input type="hidden" name="ppId" value="${pricePackage.id}"/>
                                <div class="form-group" >
                                    <label class="control-label" for="name">PACKAGE NAME</label>
                                    <div class="single-form">
                                        <input id="name" name="name" placeholder="PACKAGE NAME"
                                               class="form-control input-md" type="text" value ="${pricePackage.name}" >
                                ...
                                <div class="form-group" style="padding-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <input id="duration" name="duration" placeholder="DURATION"
                                               class="form-control input-md" type="number" min="1" value ="${pricePackage.duration}">
                                ...
                                <div class="form-group" style="padding-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <input id="listedPrice" name="listedPrice" placeholder="LISTED PRICE"
                                               class="form-control input-md" type="text" value ="${pricePackage.listedPrice}">
                                        <!--pattern="[0-9]{1,15}(.[0-9]{1,15}){0,1}"-->
                                ...
                                <div class="form-group" style="padding-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <input id="salePrice" name="salePrice" placeholder="SALE PRICE"
                                               class="form-control input-md" type="text" value="${pricePackage.salePrice}">
                                ...
                                <div class="form-group" style="padding-top: 20px;">
                                    ...
                                    <div style="padding-top: 8px">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input"  type="radio" name="status" id="active" value="1" ${pricePackage.status?"checked":""}/>
                                            <label class="form-check-label" for="active" style="font-size: 14px; color: black;">ACTIVE</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <!--<input class="form-check-input"  type="radio" name="status" id="deactive" value="0" <c:if test="${!pricePackage.status}">checked</c:if>/>-->
                                            <input class="form-check-input"  type="radio" name="status" id="deactive" value="0" ${!pricePackage.status?"checked":""}/>
                                            <label class="form-check-label" for="deactive" style="font-size: 14px; color: black;">DEACTIVE</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-top: 20px;">
                                    <div style="text-align: center" class="update ml-auto mr-auto">
                                        <button type="button" class="btn btn-primary btn-round" style="background-color: rgb(48 146 85);" onclick="checkValidation()">Edit</button>
                                        <!--<button type="submit" class="btn btn-primary btn-round" style="background-color: rgb(255 193 7)!important;">Cancel</button>-->
                                        <!--<a href="" class="btn btn-primary btn-round" style="background-color: rgb(255 193 7)!important;">Cancel</a>-->
                                    </div>
