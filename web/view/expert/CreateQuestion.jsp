                ...
                <div class="col-md-12">
                    <div class="card card-user" style="padding: 10px 10px; margin-left: 200px;margin-right: 200px; margin-top: 50px; margin-bottom: 50px;">
                        <div class="card-header">
                            <h2 class="card-title">Create question</h2>
                        </div>
                        <div class="card-body">
                            ...
                            <form action="createquestion" method="post">
                                <div class="form-group" style="margin-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <textarea id="question_content" name="content" placeholder="CONTENT"
                                                  class="form-control input-md" type="text" value=""></textarea>
                                ...
                                <div class="form-group" style="margin-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <input class="form-check-input"  type="radio" name="correct" id="inlineRadio1" value="1">
