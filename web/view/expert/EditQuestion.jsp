                ...
                <div class="col-md-12">
                    <div class="card card-user" style="padding: 10px 10px; margin-left: 200px;margin-right: 200px; margin-top: 50px; margin-bottom: 50px;">
                        <div class="card-header">
                            <h2 class="card-title">Edit a question</h2>
                        </div>
                        <div class="card-body">

                            <form action="editquestion" method="post">
                                <input type="text" hidden name="id" value="${question.getId()}"/>
                                <input type="text" hidden name="id1" value="${question.getAnswers().get(0).getId()}"/>
                                <input type="text" hidden name="id2" value="${question.getAnswers().get(1).getId()}"/>
                                <input type="text" hidden name="id3" value="${question.getAnswers().get(2).getId()}"/>
                                <input type="text" hidden name="id4" value="${question.getAnswers().get(3).getId()}"/>
                                <div class="form-group" style="margin-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <textarea id="question_content" name="content" placeholder="CONTENT"
                                                  class="form-control input-md" type="text" value="${question.getContent()}">${question.getContent()}</textarea>
                                ...
                                <div class="form-group" style="margin-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <input class="form-check-input"  type="radio" name="correct" id="inlineRadio1" value="1" <c:if test="${question.getAnswers().get(0).isCorrect() == true}">checked</c:if>>
                                        <input id="question_content" name="ans1" placeholder="ANSWER OPTION 1"
                                               class="form-control input-md" type="text" value="${question.getAnswers().get(0).getContent()}">
                                        <div id="package_name-error"></div>
                                    </div>
                                    <div class="single-form">
                                        <input class="form-check-input"  type="radio" name="correct" id="inlineRadio1" value="2" <c:if test="${question.getAnswers().get(1).isCorrect() == true}">checked</c:if>>
                                        <input id="question_content" name="ans2" placeholder="ANSWER OPTION 2"
                                               class="form-control input-md" type="text" value="${question.getAnswers().get(1).getContent()}">
                                        <div id="package_name-error"></div>
                                    </div>
                                    <div class="single-form">
                                        <input class="form-check-input"  type="radio" name="correct" id="inlineRadio1" value="3" <c:if test="${question.getAnswers().get(2).isCorrect() == true}">checked</c:if>>
                                        <input id="question_content" name="ans3" placeholder="ANSWER OPTION 3"
                                               class="form-control input-md" type="text" value="${question.getAnswers().get(2).getContent()}">
                                        <div id="package_name-error"></div>
                                    </div>
                                    <div class="single-form">
                                        <input class="form-check-input"  type="radio" name="correct" id="inlineRadio1" value="4" <c:if test="${question.getAnswers().get(3).isCorrect() == true}">checked</c:if>>
                                        <input id="question_content" name="ans4" placeholder="ANSWER OPTION 4"
                                               class="form-control input-md" type="text" value="${question.getAnswers().get(3).getContent()}">
                                        <div id="package_name-error"></div>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-top: 20px;">
                                            ...
                                            <select name="categoryId">
                                                <c:forEach items="${categories}" var="c">
                                                    <option value="${c.getId()}"  
                                                            <c:if test="${question.getCategory().getId() == c.getId()}">selected</c:if>  
                                                            >${c.getName()}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                ...
                                <div class="single-form">
                                            Publish
                                            <input class="form-check-input"  type="radio" name="status" value="1" <c:if test="${question.isStatus() == true}">checked</c:if> >
                                            Unpublish
                                            <input class="form-check-input"  type="radio" name="status" value="0" <c:if test="${question.isStatus() == false}">checked</c:if> >
                                        </div>                    
