                                    ...
                                    <div class="search-filter" >
                                        ...
                                        <div class="courses-select" style="padding: 20px;">
                                            <select onchange="this.form.submit()" name="category">
                                                ...
                                                <option selected="selected" value="cateID">cate name</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="courses-select" style="padding: 20px;">
                                            <select onchange="this.form.submit()" name="status">
                                                ...
                                                <option selected="selected" value="true">Published</option>
                                                <option selected="selected" value="false">Unpublished</option>
                                            </select>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="./packages" method="post">
                                                        ...
                                                        <div class="form-group" >
                                                            ...
                                                            <div class="single-form">
                                                                <textarea id="question_content" name="question_content" placeholder="CONTENT"
                                                        ...
                                                        <div class="form-group" >
                                                            ...
                                                            <div class="single-form">
                                                                ...
                                                                <input id="question_content" name="question_content" placeholder="ANSWER OPTION 1"
                                                                       class="form-control input-md" type="text">
                                                                <div id="package_name-error"></div>
                                                            </div>
                                                            <div class="single-form">
                                                                <input class="form-check-input"  type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option2" >
                                                                <input id="question_content" name="question_content" placeholder="ANSWER OPTION 2"
                                                                       class="form-control input-md" type="text">
                                                                <div id="package_name-error"></div>
                                                            </div>
                                                            <div class="single-form">
                                                                <input class="form-check-input"  type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option3" >
                                                                <input id="question_content" name="question_content" placeholder="ANSWER OPTION 3"
                                                                       class="form-control input-md" type="text">
                                                                <div id="package_name-error"></div>
                                                            </div>
                                                            <div class="single-form">
                                                                <input class="form-check-input"  type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option4" >
                                                                <input id="question_content" name="question_content" placeholder="ANSWER OPTION 4"
                                                                       class="form-control input-md" type="text">
                                                                <div id="package_name-error"></div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group" >
                                                            ...
                                                            <div class="single-form">
                                                                <div class="courses-select">
                                                                    <form class="formCate">
                                                                        <select name="categoryId" onchange="document.querySelector('.formCate').submit()">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${q.isStatus() == 1 ? "published" : "unpublished"}}</td>
                                        <td>
