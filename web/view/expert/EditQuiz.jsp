                        ...
                        <div class="card-body">
                            ...
                            <form action="EditQuiz" method="post">
                                ...
                                <div class="form-group" style="margin-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <input id="name" name="name" placeholder="NAME"
                                               class="form-control input-md" type="text" value="${quiz.name}" required=""/>
                                    ...
                                    <div class="single-form" style="margin: 0">
                                        <div class="courses-select" >
                                            <select id="level" name="level" >
                                                <option ${quiz.level=="Easy"?"selected":""} value="Easy">Easy</option>
                                                <option ${quiz.level=="Medium"?"selected":""} value="Medium">Medium</option>
                                                <option ${quiz.level=="Hard"?"selected":""} value="Hard">Hard</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group" style="margin-top: 30px">
                                    ...
                                    <div class="single-form"  style="margin:0;">
                                        <input id="question_content" name="hour" placeholder="HOUR" value="${quiz.duration.getHours()}"
                                               style="width:150px" type="number" min="0"> : 
                                        <input id="question_content" name="minute" placeholder="MINUTE" value="${quiz.duration.getMinutes()}"
                                               style="width:150px" type="number" min="0" max="59"> : 
                                        <input id="question_content" name="second" placeholder="SECOND" value="${quiz.duration.getSeconds()}"
                                               style="width:150px" type="number" min="0" max="59">
                                ...
                                <div class="form-group" style="margin-top: 30px;">
                                    ...
                                    <label class="control-label" for="type">TYPE</label>
                                        <input id="type" name="type" class="" type="text" value="${quiz.type}" readonly/>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-top: 40px;">
                                    <div class="update ml-auto mr-auto">
                                        <button type="submit" class="btn btn-primary btn-round" style="background-color: rgb(48 146 85);">Edit</button>
                                    </div>
