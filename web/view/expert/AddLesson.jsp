                ...
                <div class="col-md-12">
                    <div class="card card-user" style="padding: 10px 10px; margin-left: 200px;margin-right: 200px; margin-top: 50px; margin-bottom: 50px;">
                        <div class="card-header">
                            <h2 class="card-title">Add a Lesson</h2>
                        </div>
                        <div class="card-body">

                            <form action="addLesson" method="post" onsubmit="submitAdd()">

                                <input type="hidden" id="toID" value="${requestScope.topicId}" name="topicId">
                                <input type="hidden" id="coID" value="${requestScope.courseId}" name="courseId">
                                <div class="form-group" style="margin-top: 20px;">
                                    <label class="control-label" for="subject_name">NAME</label>
                                    <div class="single-form">
                                        <input id="question_content" name="lesson_name" placeholder="CONTENT"
                                ...
                                <div class="form-group" style="margin-top: 20px;">
                                    ...
                                    <div class="single-form">
                                        <input id="url" name="lesson_vid" placeholder="URL"
                                               class="form-control input-md" type="text">
                                        <div id="package_name-error"></div>
                                    </div>
                                </div>
                                ...
                                <div class="row" style="margin-top: 20px;">
                                    <div class="update ml-auto mr-auto">
                                        ...
                                        <a class="btn btn-primary btn-round" style="background-color: greenyellow;" href="CourseContentManagement?courseId=${requestScope.courseId}">Back</a>
        ...
        <script>
                                function submitAdd() {
                                    $.ajax({
                                        ...
                                        url: 'addLesson',
                                        data: {
                                            lesson_name: $("#question_content").val(),
                                            lesson_vid: $("#url").val(),
                                            lesson_des: $("#urlDes").val(),
                                            lesson_status: $("#staId").val(),
                                            topicId: $("#toID").val(),
                                            //courseId : $("#coID").val(),
                                        },
                                        success: function (data, textStatus, jqXHR) {
                                            alert('Add Successfully!');
                                            window.location.href = 'addLesson?topicId=' + data;
                                        }
                                    })
                                }
        </script>
