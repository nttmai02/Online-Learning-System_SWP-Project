                            ...
                            <form>
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach items="${requestScope.quizs}" var="c" >
                                            <tr>
                                                <td>${c.getId()}</td>
                                                <td>${c.getName()}</td>
                                                <td>${c.getLevel()}</td>
                                                ...
                                                <td>
                                                    <div style="display: flex;align-items: stretch;">
                                                        <div style="display: flex;align-items: stretch;">
                                                            ...
                                                            <a href="DeleteQuiz?topicId=${requestScope.topicId}&&quizId=${c.getId()}" class="" style="margin-left: 20px; color: red;">Remove</a>
                                                ...
                                                <td>
                                                    <div style="display: flex;align-items: stretch;">
                                                        <div style="display: flex;align-items: stretch;">
                                                            ...
                                                            <a href="AddQuiz?topicId=${requestScope.topicId}&&quizId=${q.getId()}" class="" style="margin-left: 20px; color: red;">Add</a>
                                ...
                                <div class="row" style="margin-top: 20px;">
                                    <div class="update ml-auto mr-auto">
                                        <!--<button type="" class="btn btn-primary btn-round" style="background-color: rgb(255 193 7); margin-left: 15px">-->
                                            <a class="btn btn-primary btn-round" style="background-color: rgb(255 193 7); margin-left: 15px" href="CourseContentManagement?courseId=${requestScope.courseId}">Back</a>
                                        <!--</button>-->
