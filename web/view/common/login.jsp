                                    ...
                                    <div class="form-wrapper">
                                        ...
                                        <form action="login" method="post">
                                            ...
                                            <div class="single-form">
                                                <input value="${requestScope.email}" type="email" placeholder="Email" name="email" required="">
                                            </div>
                                            <!-- Single Form End -->

                                            <!-- Single Form Start -->
                                            <div class="single-form">
                                                <input value="${requestScope.pass}" type="password" placeholder="Password" name="pass" required="">
                                            </div>
                                            <!-- Single Form End -->
                                            </br><!-- comment -->
                                            <div>
                                                ...
                                                <span style="margin-left: 125px" class="ml-auto"><a style="text-decoration: underline" href="identify" class="forgot-pass">Forgot password</a></span> 
