                        ...
                        <div class="header-main-wrapper">
                            ...
                            <div class="header-menu d-none d-lg-block">
                                <ul class="nav-menu">
                                    ...
                                    <li>
                                        <a href="${pageContext.request.contextPath}/customer/mycourse">My Course</a>
                                    </li>
                                </ul>
                                    ...
                                    <div class="form-wrapper">
                                        <form action="signup" method="post">
                                            ...
                                            <div class="single-form">
                                                <input ype="text" placeholder="Name" name="name" required="">
                                            </div>
                                            <!-- Single Form End -->
                                            <!-- Single Form Start -->
                                            <div class="single-form">
                                            ...
                                            <!-- Single Form Start -->
                                            <div class="single-form">
                                                <input pattern="^[0-9]{10,}$" type="text" placeholder="Phone" name="phone" required="">
                                            </div>
                                            <!-- Single Form End -->
                                            <!-- Single Form Start -->
                                            <div class="single-form">
                                            ...
                                            <!-- Single Form Start -->
                                            <div class="single-form">
                                                <input partern="^[0-9a-zA-Z]{6,}$" type="password" placeholder="Confirm Password" name="re-pass" required="">
