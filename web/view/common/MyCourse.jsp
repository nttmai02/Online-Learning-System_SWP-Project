<%-- 
    Document   : MyCourse
    Created on : Oct 27, 2022, 8:41:39 AM
    Author     : Dell 5510
--%>
                        ...
                        <div class="swiper-container">
                            ...
                            <ul class="swiper-wrapper nav">
                                <c:forEach items="${listCa}" var='k'>
                                    <a class="swiper-slide" href="mycourse?CateId=${k.id}">${k.name}</a>                       
                                </c:forEach>
                            </ul>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="single-courses">
                                        <div class="courses-images">
                                            <a href="${pageContext.request.contextPath}/coursedetail?id=${o.getId()}"><img src="${pageContext.request.contextPath}/assets/images/courses/${o.image}" alt="Courses"></a>
                                        </div>
                                        <div class="courses-content">
                                                ...
                                                <div class="author">
                                                    ...
                                                    <div class="author-thumb">
                                                        <c:forEach items="${o.usersTeach}" var="t">                                                                
                                                            <a href=""><img src="${pageContext.request.contextPath}/assets/images/authors/${t.image}" alt="Author"></a>                                                           
                                                            </c:forEach>
                                            ...
                                            <h4 class="title"><a href="${pageContext.request.contextPath}/coursedetail?id=${o.getId()}">${o.name}</a></h4>
                                ...
                                <form action="mycourse">
                                    <ul class="pagination justify-content-center">
                                        <c:if test="${page.getCp() != 1}">
                                            <li><a title="mycourse" href="mycourse?cp=1"><i class="icofont-rounded-double-left"></i></a></li>
                                            <li><a href="mycourse?cp=${page.getCp()-1}"><i class="icofont-rounded-left"></i></a></li>
                                                </c:if>

                                        <c:forEach begin="${page.getStartPage()}" end="${page.getEndPage()}" var="i">
                                            <li><a <c:if test="${i == page.getCp()}">class="active"</c:if> href="mycourse?cp=${i}">${i}</a></li>
                                            </c:forEach>


                                        <c:if test="${page.getCp() != page.getTp()}">
                                            <li><a href="mycourse?cp=${page.getCp()+1}"><i class="icofont-rounded-right"></i></a></li>
                                            <li><a title="End" href="mycourse?cp=${page.getTp()}"><i class="icofont-rounded-double-right"></i></i></a></li>
                                            </c:if>
                                    </ul>
                                </form>
                            </div>
